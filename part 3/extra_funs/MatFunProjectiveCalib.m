...
% ------------------------------------------------------------------------
P = zeros(3,4,2); 
% P(:,:,1) must contain proj. matrix of camera 1. 
% P(:,:,2) must contain proj. matrix of camera 2.

v = zeros(1,3);
P(:,:,1) = [eye(3),v'];
[e, ~] = NumKernel(F');
e_prime = Cross2Matrix(e);
lambda = 1;

P(:,:,2) = [e_prime * F + e * v, lambda * e];
