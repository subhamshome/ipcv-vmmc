...
%     indexPairs       = matchFeatures(features{1},features{2},'MaxRatio',MaxRatio,'Metric',Metric, 'MatchThreshold', MatchThreshold) ;
    indexPairs       = matchFeatures(features{1},features{2},'MaxRatio',MaxRatio,'Metric',Metric) ;
