...
load userpoints_part1_image2.mat;
...
%% Reading the images
im1 = imread('input_images\720p\image1.jpg');
im2 = imread('input_images\720p\image2.jpg');
im3 = imread('input_images\720p\image3.jpg');
im4 = imread('input_images\720p\image4.jpg');
im5 = imread('input_images\720p\image5.jpg');
im6 = imread('input_images\720p\image6.jpg');
im7 = imread('input_images\720p\image7.jpg');
im8 = imread('input_images\720p\image8.jpg');
im9 = imread('input_images\720p\image9.jpg');
